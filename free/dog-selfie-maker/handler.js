...
const DEFAULT_PROMPT =
  'A vertical 9:16 ordinary iPhone snapshot of a dog taking a selfie in a ' +
  'casual setting, with some accessory/prop, an awkward or goofy candid ' +
  'expression (tongue out, wonky ears, head-tilt), and an imperfection ' +
  'like blur, bad framing, slobber on the lens, clutter, or harsh ' +
  'lighting. Avoid cinematic, polished, professional, or glamour-style ' +
  'composition.';
...
export async function run(ctx, args) {
  ...
  const titleStub = override.length > 0 ? override.slice(0, 60) : 'Dog selfie';
